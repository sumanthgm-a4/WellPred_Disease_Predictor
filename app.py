...
heart_scaler, heart_model = joblib.load("/opt/render/project/src/WellPred_Disease_Predictor/models/heart_model.pkl")
...
cerv_data, cerv_scaler, cerv_model, X, y = joblib.load("/opt/render/project/src/WellPred_Disease_Predictor/models/cerv_canc_models.pkl")
...
kidney_data, kidney_scaler, kidney_model = joblib.load('/opt/render/project/src/WellPred_Disease_Predictor/models/kidney_models.pkl')
